...
import img from 'assets/img/categories/natural-stone.svg';
...
export default function PaverModal() {
    ...
    const saveItem = () => { 
        dispatch(Actions.setAddNewItem(groupsData, "natural stone", manufacturers, products, sf, isEdge, lf, color, depth, notes, option1, option2, option3, option4, option5));
        setOpen(false); 
    }
